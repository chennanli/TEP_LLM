...
<body>
    ...
    <script>
        // Minimal inline script for testing
        ...
        setTimeout(function() {
            try {
                ...
                if (statusEl) {
                    statusEl.innerHTML = '<div style="background: orange; color: white; padding: 10px;">🔧 Testing JavaScript...</div>';
                }
            } catch(e) {
                console.error('Inline JS test failed:', e);
            }
        }, 1000);

        // Functions are now in external JS file

        // All functions moved to external JS file for Safari compatibility
        ...
        function initializeApp() {
            ...
            try {
                ...
                var testButtons = document.querySelectorAll('button[onclick]');
        ...
        // Use both DOMContentLoaded and window.onload for maximum Safari compatibility
