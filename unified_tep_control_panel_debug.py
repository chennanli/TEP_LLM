...
<body>
    <div class="container">
        ...
        <div style="background: red; color: white; padding: 10px; margin: 10px;">
            <h3>🔧 DEBUG TEST</h3>
            <button onclick="alert('Button clicked!')" style="padding: 10px; font-size: 16px;">TEST BUTTON - Click Me!</button>
            <button onclick="testFunction()" style="padding: 10px; font-size: 16px;">TEST FUNCTION</button>
        </div>
    ...
    <script>
        ...
        alert('JavaScript is working - Control Panel loaded!');
